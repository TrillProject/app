...
let highlightColor = UIColor(red: 0 , green: 0 , blue: 0, alpha: 1)
=======
let highlightColor = UIColor(red: 157.0 / 255.0, green: 108.0 / 255.0, blue: 4.0 / 255.0, alpha: 1)
...
<<<<<<< HEAD
let ratingWords = ["the worst", "avoid going here", "pretty bad", "mediocre", "decent", "worth a visit", "very good", "super awesome", "spectacular", "best experience ever"]
=======
